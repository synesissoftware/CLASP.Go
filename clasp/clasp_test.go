...
func Test_single_value(t *testing.T) {
	...
	check(t, 1 == value0.CmdLineIndex, "arguments has wrong value")
...
func Test_several_values(t *testing.T) {
	...
	check(t, 2 == value1.CmdLineIndex, "arguments has wrong value")
	check(t, "g" == value2.Value, "arguments has wrong value")
	check(t, 3 == value2.CmdLineIndex, "arguments has wrong value")
	check(t, "hi" == value3.Value, "arguments has wrong value")
	check(t, 4 == value3.CmdLineIndex, "arguments has wrong value")
